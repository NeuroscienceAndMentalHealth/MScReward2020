...
```{r}
demographics<-read.csv(paste0('data/questionnaire/PROLIFIC.csv'))

#Version 7
AES<-read.csv(paste0('data/questionnaire/AES.csv'))
Consent<-read.csv(paste0('data/questionnaire/CONSENT.csv'))
Covid<-read.csv(paste0('data/questionnaire/COVID.csv'))
Fatigue<-read.csv(paste0('data/questionnaire/FATIGUE.csv'))
IPAQ<-read.csv(paste0('data/questionnaire/IPAQ.csv'))
OCIR<-read.csv(paste0('data/questionnaire/OCIR.csv'))
STAIT<-read.csv(paste0('data/questionnaire/STAIT.csv'))
STAIS<-read.csv(paste0('data/questionnaire/STAIS.csv'))
TEPS<-read.csv(paste0('data/questionnaire/TEPS.csv'))
Zung<-read.csv(paste0('data/questionnaire/ZUNG.csv'))
MHBasics<-read.csv(paste0('data/questionnaire/MHBASICS.csv'))

#Version 10
AES2<-read.csv(paste0('data/questionnaire/AES2.csv'))
Consent2<-read.csv(paste0('data/questionnaire/CONSENT2.csv'))
Covid2<-read.csv(paste0('data/questionnaire/COVID2.csv'))
Fatigue2<-read.csv(paste0('data/questionnaire/FATIGUE2.csv'))
IPAQ2<-read.csv(paste0('data/questionnaire/IPAQ2.csv'))
OCIR2<-read.csv(paste0('data/questionnaire/OCIR2.csv'))
STAIT2<-read.csv(paste0('data/questionnaire/STAIT2.csv'))
STAIS2<-read.csv(paste0('data/questionnaire/STAIS2.csv'))
TEPS2<-read.csv(paste0('data/questionnaire/TEPS2.csv'))
Zung2<-read.csv(paste0('data/questionnaire/ZUNG2.csv'))
AES2<-read.csv(paste0('data/questionnaire/AES2.csv'))
MHBasics2<-read.csv(paste0('data/questionnaire/MHBASICS2.csv'))

#Version 11
AES3<-read.csv(paste0('data/questionnaire/AES3.csv'))
Consent3<-read.csv(paste0('data/questionnaire/CONSENT3.csv'))
Covid3<-read.csv(paste0('data/questionnaire/COVID3.csv'))
Fatigue3<-read.csv(paste0('data/questionnaire/FATIGUE3.csv'))
IPAQ3<-read.csv(paste0('data/questionnaire/IPAQ3.csv'))
OCIR3<-read.csv(paste0('data/questionnaire/OCIR3.csv'))
STAIT3<-read.csv(paste0('data/questionnaire/STAIT3.csv'))
STAIS3<-read.csv(paste0('data/questionnaire/STAIS3.csv'))
TEPS3<-read.csv(paste0('data/questionnaire/TEPS3.csv'))
Zung3<-read.csv(paste0('data/questionnaire/ZUNG3.csv'))
AES3<-read.csv(paste0('data/questionnaire/AES3.csv'))
MHBasics3<-read.csv(paste0('data/questionnaire/MHBASICS3.csv'))
...
write.csv(file=paste0('data/MHBasics_clean.csv'),MHBasics_clean,row.names=FALSE)
...
overall_catch <- IPAQ_catch %>%
  inner_join(TEPS_catch) %>%
  inner_join(Zung_catch) 
```


Bind all questionnaires together
...
write.csv(file=paste0('data/questionnaire_data_clean.csv'),overall_df,row.names=FALSE)
```
