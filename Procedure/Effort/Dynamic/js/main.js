...
function PrepareTrial(){
    ...
    $('#target').hide();
    // Set animation time
    let vert_time = globals.animation_time / 1000;
...
function NextStimulus(){
    ...
    if(stim < 10){
        ...
        let t_remaining = globals.animation_time - (dt - state.stim_times[stim]);
